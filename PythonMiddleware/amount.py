...
class Amount(dict):
    """ This class deals with Amounts of any asset to simplify dealing with the tuple::
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a list of a ``float`` and a :class:`graphene.asset.Asset`
        ...
        An instance is a dictionary and comes with the following keys:
            ...
            * ``amount`` (float)
            * ``symbol`` (str)
            * ``asset`` (instance of :class:`graphene.asset.Asset`)
    ...
    """
    def __init__(self, *args, amount=None, asset=None, graphene_instance=None):
        self["asset"] = {}
        ...
        if len(args) == 1 and isinstance(args[0], Amount):
            ...
            self["asset"] = Asset(self["symbol"], graphene_instance=self.graphene)

        elif (len(args) == 1 and
                isinstance(args[0], dict) and
                "amount" in args[0] and
                "asset_id" in args[0]):
            self["asset"] = Asset(args[0]["asset_id"], graphene_instance=self.graphene)
            ...
            self["amount"] = int(args[0]["amount"]) / 10 ** self["asset"]["precision"]
                ...
                "amount" in args[0] and
                "asset" in args[0]):
            self["asset"] = Asset(args[0]["asset"], graphene_instance=self.graphene)
            self["symbol"] = self["asset"]["symbol"]
            self["amount"] = int(args[0]["amount"]) / 10 ** self["asset"]["precision"]
            ...
            self["amount"] = args[0]
            self["asset"] = Asset(args[1], graphene_instance=self.graphene)
            self["symbol"] = self["asset"]["symbol"]
    ...
    @property
    def asset(self):
        """ Returns the asset as instance of :class:`graphene.asset.Asset`
        """
        if not self["asset"]:
            self["asset"] = Asset(self["symbol"], graphene_instance=self.graphene)
        return self["asset"]
