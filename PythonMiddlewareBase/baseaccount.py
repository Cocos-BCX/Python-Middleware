...
class Address(object):
    ...
    """
    def __init__(self, address=None, pubkey=None, prefix=default_prefix):
        self.prefix = prefix
...
class PublicKey(Address):
    ...
    """
    def __init__(self, pk, prefix=default_prefix):
        self.prefix = prefix
...
class PrivateKey(PublicKey):
    ...
    """
    def __init__(self, wif=None, prefix=default_prefix):
        if wif is None:
            import os
